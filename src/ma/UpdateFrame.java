...
//Adding UpdateFrame to GUI window using Swing
...
c.add(btnBack);
 ...
 //Adding action to Save Window to save the updates in record
...
//Adding action to Back Button to go back to Main Frame
